            ...
            <div class="page__inner">
                <div class="page__menu">
					...
					<%for(specialite x : specialites){ %>
						...
						<c:url var="EditPlaces" value="ViceDoyenServlet">
							<c:param name="command" value="EditPlaces"/>
							<%String S = x.getName(); %>	
							<c:param name="SpecName" value="<%=S %>"/>
						</c:url>
						
						
                        <li><a href="${ specialiteLink}"><%=x.getName() %></a> | <a href="${EditPlaces }">Edit</a></li>
					<%} %>
                    </ul>
                </div>
                <div class="page__main">
                    <div class="text-container">
                        ...
                        <%List<student> specStudents = (List<student>) request.getAttribute("specStudents"); %>	
                        <table cellspacing="10">
							...
							<%for(student tempStudent : specStudents){ %>
								<c:url var="acceptLink" value="ViceDoyenServlet">
									<c:param name="command" value="acceptEmail" />
									<% String E = tempStudent.getEmail();	%>
									
									<c:param name="studentEmail" value="<%= E %>" />
								</c:url>
								<c:url var="refuseLink" value="ViceDoyenServlet">
									<c:param name="command" value="refuseEmail" />
									<% String E = tempStudent.getEmail();	%>
								...
								<tr>
									...
									<td><a href="${acceptLink }">Accept</a>
											|
										<a href="${ refuseLink }">Refuse</a>	
									</td>
								</tr>
