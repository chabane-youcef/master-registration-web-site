...
<head>
    ...
    <title>Refused Students | Responsable</title>
        ...
        <div class="container">
            <div class="navbar__inner">
                ...
                <nav class="navbar__menu">
                    <ul>
                        <li><a href="main.jsp"><%= session.getAttribute("responsable_fname") %></a></li>
            ...
            <div class="container">
                <div class="page__header__content">
                    <div class="page__header__content__inner" id='navConverter'>
                        <h1 class="page__header__title">Refused Students table</h1>
        ...
        <div class="container">
            <div class="page__inner">
                <div class="page__menu">
                   ...
                   <c:url var="deletedList" value="ResponsableServlet">
					...
					<c:url var="acceptedList1" value="ResponsableServlet">
                        ...
                        <li><a href="${ deletedList}" class="vMenu--active">See deleted Students</a></li>
                ...
                <div class="page__main">
                    ...
                    <%
						List<student> x = (List<student>) request.getAttribute("refusedStudents");
					%>
                        ...
                        <table cellspacing="5">
							...
							<%for(student tempStudent : x){ %>
								<c:url var="addLink" value="ResponsableServlet">
